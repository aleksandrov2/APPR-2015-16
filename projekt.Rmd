...
```{r graf1, echo=FALSE, warning=FALSE, fig.cap='Dolg evropskih drzav leta 2006', fig.align='center'}
print(prvi_graf)
```

```{r graf2, echo=FALSE, warning=FALSE, fig.cap='Dolg evropskih drzav leta 2014', fig.align='center'}
print(drugi_graf)
```
...
```
```{r zem3, echo=FALSE, warning=FALSE, fig.cap='Primerjava zadolzenosti drzav sveta v letu 2015', fig.align='center'}
print(zem3)
```

```{r zem4, echo=FALSE, warning=FALSE, fig.cap='Primerjava zadolzenosti drzav sveta v letu 2015', fig.align='center'}
print(zem4)
```
