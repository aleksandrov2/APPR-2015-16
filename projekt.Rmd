...
sliderInput("leto", "Leto:", min = 2006, max = 2014, value = 2006,sep="")

renderPlot({
  ggplot(podatki3 %>% filter(Cas == input$leto),
...
renderTable({
napoved <- lm(data = podatki3 %>% filter(Cas == input$leto), Deficit ~ Dolg)
