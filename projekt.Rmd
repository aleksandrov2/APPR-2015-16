...
Podatke za prvi dve tabeli sem našel na spletni strani OECD. Tam sem izbral samo podatke evropskih držav, potem pa sem prenesel cvs datoteki na računalnik. Tabelo, ki prikazuje tudi dolg ZDA v letih 2007, 2010 in 2011 v primerjavi z evropskimi državami, pa sem našel na wikipediji. 
...
Prva tabela prikazuje dolg evropskih držav, druga deficit teh držav in tretja prikazuje dolg ZDA v primerjavi z evropo. 

Prva tabela:
Sestavljena je iz stoplcev LOCATION,	INDICATOR,	SUBJECT,	MEASURE,	FREQUENCY,	TIME in	Value	Flag Codes.
