...
sliderInput("leto_1", "Leto:", min = 2006, max = 2014, value = 2006,sep="")

renderPlot({
  ggplot(podatki1 %>% filter(Cas == input$leto), aes(x = Drzava, y = Dolg, fill=Dolg)) + 
...
sliderInput("leto_2", "Leto:", min = 2006, max = 2014, value = 2006,sep="")

renderPlot({
  ggplot(podatki2 %>% filter(Cas == input$leto), aes(x = Drzava, 
...
renderPlot({
  ...
  geom_smooth(method = "lm") + xlim(0, 190) + ylim(-15, 5)
})
