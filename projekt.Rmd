...
print(deseti_graf+ geom_smooth(method = "lm"))
```
...
Ustvaril sem tudi zemljevida, ki prikazujeta zadolženost evrope in sveta v letu 2014. Opazimo lahko, da so razvite države kot na primer ZDA, Japonska, Kanada, države zahodne evrope zelo visoko zadolžene, medtem ko imajo države v razvoju zelo nizke zadolženosti. Problem nastaja zaradi tega, ker imajo manj razvite države zelo visoko stopnjo varčevanja in nekaj od tega denarja posojajo nam po nizkih obrestnih merah. Posledica tega globalno-trgovskega neravnovesja je, da so se razvite države zelo zadolžile. 
...
```{r zem4, echo=FALSE, warning=FALSE, fig.cap='Razdelitev evropskih drzav v 5 skupin', fig.align='center'}
print(zem4)
```
...
```{r dend2, echo=FALSE, warning=FALSE, fig.cap='Razporeditev z metodo centroid', fig.align='center'}
plot(dend2, main="Razporeditev držav", sub="")
```