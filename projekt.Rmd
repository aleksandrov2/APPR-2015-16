...
radioButtons("variable","Drzave:",inline=TRUE,choices = c('AUT',"BEL","CZE","DNK","FIN","FRA","DEU","GRC","HUN","IRL","ITA","LUX","NLD","POL","PRT","SVK","ESP","SWE","GBR","EST","SVN"))
...
renderPlot({
  ...
  ggplot() + geom_polygon(data = evropa, aes(x=long, y=lat, group = group, fill = Dolg),
...
sliderInput("leto_4", "Leto:", min = 2006, max = 2014, value = 2006,sep="")
...
renderPlot({
  ...
  geom_smooth(method = "lm") + xlim(0, 190) + ylim(-33, 6)
})
