...
```{r deficiti_2014, echo=FALSE}
kable(head(deficiti_2014))
```

```{r evropa_dolgovi, echo=FALSE}
kable(head(evropa_dolgovi))
```
```{r evropa_deficiti, echo=FALSE}
kable(head(evropa_deficiti))
```
...
```{r graf12, echo=FALSE, warning=FALSE, fig.cap='Zadolženost evropskih držav, Japonske in ZDA leta 2011'}
